...
const {products , error , isLoading} = useProducts()
  ...
  return (
    <>
      {isLoading ? <div className="fixed inset-0 h-screen bg-white flex justify-center items-center"><img src="images/loading.png" className="md:w-36" alt="loading" loading="lazy" /></div> :
